...
- [RustViz](#rustviz)
  ...
  - [Data Structures and Function Specifications](#data-structures-and-function-specifications)
  - [Modules](#modules)
...
2. [svg_generator](svg_generator)
    ...
    a. [examples](../examples): contains all examples to be rendered
    ...
    | [line_styles.rs](svg_generator/src/line_styles.rs) | Defines corresponding timeline status for a resource (owner, reference, data)  |
