fn main() {
    ...
    let <tspan data-hash="3">z</tspan> = <tspan data-hash="1">&amp;mut x</tspan>; // OK, because y's lifetime has ended (last use was on previous line)
...
fn <tspan class="fn" data-hash="0" hash="6">world</tspan>(<tspan data-hash="4">s</tspan> : &amp;mut String) {
    <tspan data-hash="4">s</tspan>.<tspan class="fn" data-hash="0" hash="7">push_str(", world")</tspan>;
}
