...
fn main() {
    ...
    <tspan class="fn" data-hash="0" hash="6">println!</tspan>("{}", <tspan data-hash="1">f</tspan>.<tspan data-hash="2">x</tspan>);
    <tspan class="fn" data-hash="0" hash="6">println!</tspan>("{}", <tspan data-hash="1">f</tspan>.<tspan data-hash="3">y</tspan>);
}
