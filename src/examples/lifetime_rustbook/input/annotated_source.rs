...
fn main(){
    ...
    {
        let <tspan data-hash="1">rust_book</tspan> = Book::new(<tspan data-hash="2">&name</tspan>, serial_num);
        println!("The name of the book is {}", <tspan data-hash="1">rust_book.name</tspan>);
    }
